TEXTS = {
    ...
    "menu_add_work": "➕ Добавить работу",
    "menu_settings": "⚙️ Настройки",
    "menu_order_service": "🎼 Заказать услугу",
    "menu_become_creator": "🎨 Стать исполнителем",
    "menu_application_pending": "⏳ Заявка на рассмотрении",
    "menu_creator_panel": "🎛 Панель исполнителя",
    "menu_portfolio": "🖼 Портфолио",
    "menu_creator_orders": "📁 Заказы в работе",
    "menu_upload_review": "📸 Загрузить отзыв",
    "menu_back_main": "⬅️ В главное меню",
    "back": "⬅️ Назад",
    "wip": "🚧 Раздел в разработке.",
    # Настройки / язык
    "settings_root": "⚙️ Настройки",
    "settings_choose_lang": "🌐 Выберите язык интерфейса:",
    "settings_lang_saved": "✅ Язык интерфейса обновлён.",
    # Заявка исполнителя (из меню)
    "become_creator_intro": "🎨 Заполним заявку исполнителя. Отвечайте по одному сообщению.",
    "creator_already_approved": "✅ Вы уже исполнитель. Откройте «🎛 Панель исполнителя».",
    "application_pending_info": "⏳ Ваша заявка на рассмотрении. Админ свяжется с вами.",
    "creator_need_username": (
        "⚠️ Для заявки нужен @username в Telegram — по нему с вами свяжется админ. "
        "Задайте его в настройках Telegram и нажмите «🎨 Стать исполнителем» снова."
    ),
    "app_media_prompt": (
        "📎 Хотите — пришлите примеры работ в портфолио (фото/видео/аудио/файл), по одному. "
        "Когда закончите — нажмите «Готово»."
    ),
    "app_media_added": "✅ Добавлено. Пришлите ещё или нажмите «Готово».",
    "btn_app_media_done": "✅ Готово",
    "btn_view_portfolio": "🖼 Портфолио",
    # Каркас форм
    "form_cancel": "❌ Отмена",
    "form_step": "🔹 Шаг {n}/{total}",
    "need_text": "⚠️ Нужен текст. Пришлите ответ текстом.",
    "need_photo": "⚠️ Нужно фото. Пришлите изображением.",
    "need_media": "⚠️ Пришлите медиа: фото, видео, аудио или файл.",
    # Портфолио
    "portfolio_only_creator": "⛔ Портфолио доступно одобренным исполнителям.",
    "portfolio_empty": "🖼 Портфолио пусто. Добавьте первый элемент.",
    "portfolio_add_prompt": "Пришлите один медиа-элемент портфолио: фото, видео, аудио или файл.",
    "portfolio_caption_prompt": "Добавьте подпись к элементу (или «-» чтобы пропустить):",
    "portfolio_saved": "✅ Элемент добавлен в портфолио.",
    "portfolio_deleted": "🗑 Элемент удалён.",
    "portfolio_card": "🖼 Портфолио {pos}/{total}{caption}",
    "btn_portfolio_add": "➕ Добавить",
    "btn_portfolio_del": "🗑 Удалить текущий",
    # Модерация (админу)
    "mod_new_creator": (
    ...
    # --- Мои заказы / карточка / цикл ---
    "menu_my_orders": "📁 Мои заказы",
    "hub_orders_client": "📁 Ваши заказы:",
    "hub_orders_creator": "📁 Ваши заказы в работе:",
    "hub_orders_empty": "У вас пока нет активных заказов.",
    "order_card_header": "📦 <b>Заказ #{order_id}</b> · {title}\nСтатус: {status}",
    "order_card_contact_creator": "👤 Исполнитель: {contact}",
    "order_card_contact_client": "👤 Клиент: {contact}",
    "order_first_pay": "💳 Внесите <b>50% предоплаты</b> по реквизитам:\n{details}",
    "order_second_pay": "💳 Внесите <b>оставшиеся 50%</b> по реквизитам:\n{details}",
    "ostatus_published": "🟣 опубликован",
    "ostatus_taken": "🟡 взят, ждём вашего подтверждения",
    "ostatus_await_prepay": "💳 ожидает предоплату 50%",
    "ostatus_in_progress": "🔧 в работе",
    "ostatus_demo_review": "🔵 демо на утверждении",
    "ostatus_await_final": "💳 ожидает финальную оплату 50%",
    "ostatus_completed": "✅ завершён",
    "ostatus_cancelled": "❌ отменён",
    "btn_demo_done": "✅ Демо готово",
    "btn_approve_demo": "✅ Утвердить демо",
    "btn_paid": "💸 Я оплатил",
    "btn_republish": "♻️ Опубликовать снова",
    "btn_orders_back": "⬅️ К списку",
    # уведомления-пинги (карточка приходит отдельно)
    "notify_creator_confirmed": "🙌 Клиент утвердил вас по заказу #{order_id}. Ждём предоплату.",
    "notify_demo_to_client": "🔔 По заказу #{order_id} исполнитель сдал демо — проверьте и утвердите.",
    "notify_demo_approved_creator": "🔔 Клиент утвердил демо по заказу #{order_id}. Ждём финальную оплату.",
    "notify_paid_admin": "🔔 Клиент отметил оплату по заказу #{order_id}. Проверьте и подтвердите финал.",
    "notify_republished": "♻️ Заказ #{order_id} снова опубликован в чате исполнителей.",
    "order_paid_waiting": "Отмечено. Ожидайте подтверждения оплаты администратором.",
    ...
    "adm_btn_writeoff": "💸 Списать",
    "adm_btn_credit": "➕ Начислить",
    "adm_ask_credit": "Введите сумму начисления (число):",
    "adm_credit_done": "✅ Начислено {amount} ₽. Новый баланс: {balance} ₽.",
    ...
    # --- Админ за исполнителя ---
    "adm_btn_edit_profile": "✏️ Профиль",
    "adm_btn_add_work": "➕ Работа за автора",
    "adm_cprofile_title": "Что изменить у исполнителя #{cid}?",
    "adm_btn_ef_service": "Услуга",
    "adm_btn_ef_socials": "Соцсети",
    "adm_btn_ef_desc": "Описание",
    "adm_ask_service": "Новая услуга:",
    "adm_ask_socials": "Новые соцсети:",
    "adm_ask_desc": "Новое описание:",
    "adm_profile_saved": "✅ Профиль исполнителя обновлён.",
    "adm_work_added_direct": "✅ Работа добавлена в каталог за исполнителя (одобрено).",
    # --- Отзывы ---
    ...
    # --- Добавление работы (выбор типа) ---
    "addwork_choose": "Добавить в каталог:",
    "cancelled": "❌ Отменено.",
    "addwork_beat": "🎧 Бит",
    ...
    "addvisual_type": "Тип (обложка / баннер / арт / логотип / 3D):",
    "addvisual_cover": "Пришлите изображение работы (фото):",
    "addvisual_cover_invalid": "Нужно фото. Пришлите изображение.\n/cancel — отмена",
    "addvisual_price_buy": "💰 Цена (руб.):",
    "addvisual_sent": "✅ Визуал отправлен на модерацию.",
    "mod_new_visual": (
        "🆕 <b>Новый визуал на модерацию</b>\n\n"
        "Автор: {author}\n"
        "Название: {title}\n"
        "Тип: {vtype}\n"
        "Цена: {buy} ₽"
    ),
    # обобщённые уведомления автору
    "work_approved_notify": "✅ Ваша работа «{title}» одобрена и добавлена в каталог.",
    "work_rejected_notify": "❌ Ваша работа «{title}» отклонена модерацией.",
    # --- Карточка визуала в каталоге ---
    "visual_card": (
        "🖼 <b>{title}</b>\n"
        "Автор: {author}\n"
        "Тип: {vtype}\n"
